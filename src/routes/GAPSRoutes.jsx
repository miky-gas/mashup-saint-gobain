...
const GAPSDashboard = React.lazy(() => import('@pages/GAPS/GAPSDashboard'));
...
export default [
    ...
    {
        name: 'home.GAPS.Dashboard',
        url: '/GAPS',
        component: GAPSDashboard,
        label: 'Dashboard',
        toSheet: true,
        params: {
            idFav: null,
            IDFILTRO: {
                ...
                value: [
                    ...
                    { title: 'Periodo', idFiltro: 'yzpmDhV' },
                    { title: 'Datos Usuario', idFiltro: 'ApnjQW' },
                ]
            },
            PATH: ['GAPS'],
            OBJECTSTOP: {
