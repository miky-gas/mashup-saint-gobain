    ...
    return (
        <React.Fragment>
                <div className="flex-component" id="scrollable-view">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12 mzh-xl-30 mzh-lg-30 mzh-md-30 mzh-sm-30 mzh-xs-30 mzh-30 box_object">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12 mzh-xl-70 mzh-lg-70 mzh-md-70 mzh-sm-70 mzh-xs-70 mzh-70 box_object">
