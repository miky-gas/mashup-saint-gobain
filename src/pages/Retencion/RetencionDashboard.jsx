        ...
        <React.Fragment>
                <div className="flex-component" id="scrollable-view">
                    ...
                    <div className=" flex-component flex-row col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 mzh-xl-100 mzh-lg-100 mzh-md-100 mzh-sm-100 mzh-xs-100 mzh-100 box_object" >
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-xs-4 mzh-xl-25 mzh-lg-25 mzh-md-25 mzh-sm-25 mzh-xs-25 mzh-25 box_object">
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-xs-4 mzh-xl-25 mzh-lg-25 mzh-md-25 mzh-sm-25 mzh-xs-25 mzh-25 box_object">
                                    <GenericQlikObject aplication={props.aplication} qlikObjectID={'XjmDP'} visual="" onObjectLoaded={ObjectLoaded} location={ROUTER.globals.current.name} router={ROUTER}></GenericQlikObject>
                        </div>
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-4 col-xs-4 mzh-xl-20 mzh-lg-20 mzh-md-20 mzh-sm-20 mzh-xs-20 mzh-20 box_object">
                                    <GenericQlikObject aplication={props.aplication} qlikObjectID={'DAMa'} visual="" onObjectLoaded={ObjectLoaded} location={ROUTER.globals.current.name} router={ROUTER}></GenericQlikObject>
                        </div>
                    </div>
