                ...
                <div className="sc_menu clearfix" ref={menuRef}>
                    <div id="box_ListaMenu">
                        ...
                        <ul id="listaMenuContenidos" ref={listaMenuContenidosRef}>
                                ...
                                <li onMouseEnter={handleMouseEnter}>
                                    <UISref to="home.Matriz.Dashboard">
                                        <a href="javascript:void(0)" className="menu-item">
                                            <span className="menu-item-text">Matriz</span>
                                        </a>
                                    </UISref>
                                </li>
                            </UISrefActive>
                         ...
                         {/*    <UISrefActive className="active-item">
                                <li onMouseEnter={handleMouseEnter}>
                                    <UISref to="home.Ventas.Reporting">
                                        <a href="javascript:void(0)" className="menu-item">
                                            <span className="menu-item-text">Reporting</span>
                                        </a>
                                    </UISref>
                                </li>
                            </UISrefActive> */}
                        {/*     <UISrefActive className="active-item">
                                <li onMouseEnter={handleMouseEnter}>
                                    <UISref to="home.Ventas.KPI">
                                        <a href="javascript:void(0)" className="menu-item">
                                            <span className="menu-item-text">KPI</span>
                                        </a>
                                    </UISref>
                                </li>
                            </UISrefActive> */}
                      {/*       <UISrefActive className="active-item">
                                <li onMouseEnter={handleMouseEnter}>
                                    <UISref to="home.Ventas.CustomSheets">
                                        <a href="javascript:void(0)" className="menu-item">
